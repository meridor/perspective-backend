...
public class AcosFunctionTest {
    ...
    public void validateInput() throws Exception {
        ...
        assertThat(function.validateInput(Collections.singletonList(2)), is(not(empty())));
        assertThat(function.validateInput(Collections.singletonList(1)), is(empty()));
    }

    @Test
    public void apply() throws Exception {
        assertThat(function.apply(Collections.singletonList(1)), equalTo(0d));
    }

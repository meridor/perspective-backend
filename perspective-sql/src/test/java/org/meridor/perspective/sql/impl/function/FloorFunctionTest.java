...
public class FloorFunctionTest {
    ...
    @Autowired
    private FloorFunction function;
    ...
    public void apply() throws Exception {
        assertThat(function.apply(Collections.singletonList(1.5)), equalTo(1));
        assertThat(function.apply(Collections.singletonList(-1.5)), equalTo(-2));
    }

...
@Component
public class TanFunction implements Function<Double> {
    ...
    public Double apply(List<Object> objects) {
        return Math.tan(Double.valueOf(String.valueOf(objects.get(0))));
    }
    ...
    public String getDescription() {
        return "Returns the tangent of X, where X is given in radians. ";
    }

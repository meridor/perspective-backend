...
public class SelectQueryTest {
    ...
    public void testSelectAll() {
        ...
        assertThat(query.getParameters(), is(empty()));
    }
    ...
    public void testSimpleWhereClause() {
        ...
        assertThat(query.getParameters(), hasSize(3));
        ...
        Parameter thirdParameter = query.getParameters().get(2);
    ...
    public void testMatches() {
        ...
        Parameter fourthParameter = query.getParameters().get(3);

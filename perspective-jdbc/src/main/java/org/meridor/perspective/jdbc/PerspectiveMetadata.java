...
public class PerspectiveMetadata extends BaseEntity implements DatabaseMetaData {
    
    private final PerspectiveConnection connection;

    public PerspectiveMetadata(PerspectiveConnection connection) {
    ...
    public String getDriverName() throws SQLException {
        return "perspective-jdbc";
    }

    @Override
    public String getDriverVersion() throws SQLException {
        return DriverVersionProvider.getVersion();
    }
    ...
    public ResultSet getProcedures(String catalog, String schemaPattern, String procedureNamePattern) throws SQLException {
        return PerspectiveResultSet.empty();
    }
